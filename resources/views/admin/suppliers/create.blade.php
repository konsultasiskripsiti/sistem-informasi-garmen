<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Create Supplier</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan supplier baru ke sistem.</p>
            </div>
        ...
        <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input id="supplier_code" name="supplier_code" type="text" value="{{ old('supplier_code', 'KDS001') }}" class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 outline-none transition focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">
            ...
            <div>
                ...
                <input id="person_in_charge" name="person_in_charge" type="text" value="{{ old('person_in_charge') }}" class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 outline-none transition focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="4" class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 outline-none transition focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">{{ old('address') }}</textarea>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input id="phone_number" name="phone_number" type="text" value="{{ old('phone_number') }}" class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 outline-none transition focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="rounded-xl bg-brand-500 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-brand-600">Create Supplier</button>
            </div>
        </form>
    </div>
</x-app-layout>
