...
<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
    ...
    <div class="my-6 rounded-2xl border border-gray-200 bg-linear-to-br from-brand-50 to-white px-5 py-6 dark:border-gray-800 dark:from-brand-500/10 dark:to-gray-900">
        <div class="flex items-start justify-between gap-4">
            <div>
                <p class="text-sm font-semibold text-gray-800 dark:text-white/90">Top Region Snapshot</p>
                <p class="mt-1 text-theme-sm text-gray-500 dark:text-gray-400">
                    Demo map diganti dengan ringkasan statis supaya TailAdmin langsung jalan di project ini.
                </p>
            </div>
